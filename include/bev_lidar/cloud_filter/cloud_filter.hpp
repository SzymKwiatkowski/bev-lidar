...
#ifndef CLOUD_FILTER__BEV_LIDAR_HPP_
#define CLOUD_FILTER__BEV_LIDAR_HPP_
...
class BEV_LIDAR_PUBLIC CloudFilter
{
public:
  CloudFilter();
  CloudFilter(pcl::PointCloud<pcl::PointXYZI>::Ptr input_cloud);
    ...
    tf2::Stamped<tf2::Transform> getBaseVeloTF(){
    ...
    std::stringstream python_cmd_;
};

}  // namespace bev_lidar

#endif  // BEV_LIDAR__BEV_LIDAR_HPP_
